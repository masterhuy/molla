...
class Setting
{
    ...
    static $settings = array(
        ...
        'body_text_color' => array('type' => 'default', 'value' => '#555555'),
        'body_link_color' => array('type' => 'default', 'value' => '#303030'),
        'body_link_hover_color' => array('type' => 'default', 'value' => '#000000'),
        'body_lineheight' => array('type' => 'default', 'value' => '1.5'),
        'body_fontweight' => array('type' => 'default', 'value' => '400'),
        ...
        'hormenu_align' => array('type' => 'default', 'value' => 'center', 'front' => 1),
        ...
        'cart' => array('type' => 'default', 'value' => '1', 'front' => 1),
        'cart_icon' => array('type' => 'icon', 'value' => 'icon-cart-8', 'front' => 1),
        'icon_thickness' => array('type' => 'default', 'value' => '_light', 'front' => 1),
        ...
        'cart_type' => array('type' => 'default', 'value' => 'dropdown', 'front' => 1),
        'cart_subtotal' => array('type' => 'default', 'value' => '', 'front' => 1),
        'cart_total' => array('type' => 'default', 'value' => '1', 'front' => 1),
        'addtocart_type' => array('type' => 'default', 'value' => 'popup', 'front' => 1),
        'addtocart_notification_color' => array('type' => 'default', 'value' => ''),
        'search' => array('type' => 'default', 'value' => '1', 'front' => 1),
        'search_ajax' => array('type' => 'default', 'value' => '0', 'front' => 1),
        ...
        'wishlist' => array('type' => 'default', 'value' => '1', 'front' => 1),
        'wishlist_icon' => array('type' => 'icon', 'value' => 'icon-wishlist-1', 'front' => 1),
        'customersignin' => array('type' => 'default', 'value' => '1', 'front' => 1),
        'customersignin_icon' => array('type' => 'icon', 'value' => 'icon-user-15', 'front' => 1),
        ...
        'close_icon' => array('type' => 'icon', 'value' => 'icon-close', 'front' => 1),
        'delete_icon' => array('type' => 'icon', 'value' => 'icon-deleted-1', 'front' => 1),
        'grid_icon' => array('type' => 'icon', 'value' => 'icon-grid1', 'front' => 1),
        'list_icon' => array('type' => 'icon', 'value' => 'icon-list-1', 'front' => 1),
        'menu_icon' => array('type' => 'icon', 'value' => 'icon-menu-1', 'front' => 1),
        'more_icon' => array('type' => 'icon', 'value' => 'icon-more', 'front' => 1),
        'less_icon' => array('type' => 'icon', 'value' => 'icon-less', 'front' => 1),
        'left_icon' => array('type' => 'icon', 'value' => 'icon-left', 'front' => 1),
        'right_icon' => array('type' => 'icon', 'value' => 'icon-right', 'front' => 1),
        'send_icon' => array('type' => 'icon', 'value' => 'icon-send-2', 'front' => 1),
        'preview_icon' => array('type' => 'icon', 'value' => 'icon-preview', 'front' => 1),
        'calendar_icon' => array('type' => 'icon', 'value' => 'icon-calendar1', 'front' => 1),
        'comment_icon' => array('type' => 'icon', 'value' => 'icon-comment1', 'front' => 1),
        'facebook_icon' => array('type' => 'icon', 'value' => 'icon-facebook', 'front' => 1),
        'twitter_icon' => array('type' => 'icon', 'value' => 'icon-twitter', 'front' => 1),
        'youtube_icon' => array('type' => 'icon', 'value' => 'icon-youtube', 'front' => 1),
        'whatsapp_icon' => array('type' => 'icon', 'value' => 'icon-whatsapp_two', 'front' => 1),
        'instagram_icon' => array('type' => 'icon', 'value' => 'icon-instagram', 'front' => 1),
        'skype_icon' => array('type' => 'icon', 'value' => 'icon-skype_two', 'front' => 1),
        'linkedin_icon' => array('type' => 'icon', 'value' => 'icon-linkedin', 'front' => 1),
        'pinterest_icon' => array('type' => 'icon', 'value' => 'icon-pinterest', 'front' => 1),
        ...
        'productbox_wishlist' => array('type' => 'default', 'value' => '1', 'front' => 1, 'css' => 'no'),
        'productbox_price' => array('type' => 'default', 'value' => '1', 'front' => 1, 'css' => 'no'),
        'productbox_category' => array('type' => 'default', 'value' => '0', 'front' => 1, 'css' => 'no'),
        'productbox_variant' => array('type' => 'default', 'value' => '0', 'front' => 1, 'css' => 'no'),
