...
<div class="pagebuilder-panel">
	...
	<div id="pagebuilder-setting">
	    ...
	    <div class="setting-right pull-right">
					<a class="btn" target="_blank" href="{$link->getAdminLink('AdminGdzThemeSetting') nofilter}&configure=gdz_themesetting" title="{l s='Theme Setting' mod='gdz_pagebuilder'}"><i class="pb-icon-general"></i></a>
					<div class="dropdown btn" id="template-tool">
						<button class="dropbtn"><i class="pb-icon-library"></i></button>
						<div class="dropdown-content">
							<ul class="drop-list template-icons">
								<li><a id="template-library" class="dialog-open" data-dialog="template-library" data-form="library"><span class="icon"><i class="pb-icon-library"></i></span><span class="drop-text">{l s='Template Library' mod='gdz_pagebuilder'}</span></a></li>
								<li><a class="dialog-open" data-dialog="template-library" data-form="save"><span class="icon"><i class="pb-icon-save-to-template"></i></span><span class="drop-text">{l s='Save to Template' mod='gdz_pagebuilder'}</span></a></li>
								<li><a class="dialog-open" data-dialog="template-library" data-form="file"><span class="icon"><i class="pb-icon-save-to-file"></i></span><span class="drop-text">{l s='Save as File' mod='gdz_pagebuilder'}</span></a></li>
							</ul>
						</div>
					</div>
					<div class="dropdown btn" id="tool-device">
						<button class="dropbtn"><i class="pb-icon-desktop"></i></button>
						<div class="dropdown-content">
							<ul class="drop-list device-icons">
								<li class="active" data-device="xl"><a class="xl-device"><span class="icon"><i class="pb-icon-desktop"></i></span><span class="drop-text device">{l s='Desktop' mod='gdz_pagebuilder'}</span></a></li>
								<li data-device="sm"><a class="sm-device"><span class="icon"><i class="pb-icon-tablet"></i></span><span class="drop-text device">{l s='Tablet' mod='gdz_pagebuilder'}</span></a></li>
								<li data-device="xs"><a class="xs-device"><span class="icon"><i class="pb-icon-mobile"></i></span><span class="drop-text device">{l s='Mobile' mod='gdz_pagebuilder'}</span></a></li>
							</ul>
						</div>
					</div>
					<a class="btn" target="_blank" href="{$live_link}">{l s='Live Editor' mod='gdz_pagebuilder'}</a>
	        <a class="btn" target="_blank" href="{$page_link}" title="{l s='Preview' mod='gdz_pagebuilder'}"><i class="pb-icon-preview"></i></a>
