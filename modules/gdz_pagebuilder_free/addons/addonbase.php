...
class gdzAddonBase extends Module
{
    ...
    {
        $pro_arr = array('banner', 'service', 'video', 'sliderlayer', 'blog' ,'testimonial', 'popup', 'map', 'menu', 'producttab', 'categoryproduct', 'categorytab', 'countdown', 'bannercountdown', 'instagram', 'hotdeal', 'flashsale');
        ...
        } elseif(in_array($this->addonname, $pro_arr)) {
            $html = '<a class="addon-title disabled" data-type="html" title="You need upgrade to Advanced Package to use this addon.">';
        } else {
    ...
    public function genEditorAddonList()
    {
        ...
        $pro_arr = array('banner', 'service', 'video', 'sliderlayer', 'blog' ,'testimonial', 'popup', 'map', 'menu', 'producttab', 'categoryproduct', 'categorytab', 'countdown', 'bannercountdown', 'instagram', 'hotdeal', 'flashsale');
        if (!Module::isInstalled($this->modulename) || in_array($this->addonname, $pro_arr))
