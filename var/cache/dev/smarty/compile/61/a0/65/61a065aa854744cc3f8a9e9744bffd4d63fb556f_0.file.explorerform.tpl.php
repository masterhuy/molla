<?php
/* Smarty version 3.1.33, created on 2020-07-14 08:59:43
  from 'D:\xampp\htdocs\jms_molla\modules\gdz_pagebuilder\views\templates\admin\gdzpagebuilder_media\explorerform.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5f0d118fdd8da8_06973208',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '61a065aa854744cc3f8a9e9744bffd4d63fb556f' => 
    array (
      0 => 'D:\\xampp\\htdocs\\jms_molla\\modules\\gdz_pagebuilder\\views\\templates\\admin\\gdzpagebuilder_media\\explorerform.tpl',
      1 => 1594026290,
      2 => 'file',
    ),
  ),
...
function content_5f0d118fdd8da8_06973208 (Smarty_Internal_Template $_smarty_tpl) {
?><form name="adminForm" action="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminGdzpagebuilderMedia'),'html','UTF-8' ));?>
" method="post" enctype="multipart/form-data">
<div class="explorer-form">
	<div class="col-sm-12 row">
		<div class="media-form path-form">
			<i class="icon-folder-open"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Path','mod'=>'gdz_pagebuilder'),$_smarty_tpl ) );?>
 : <?php if ($_smarty_tpl->tpl_vars['media_folder']->value) {
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['media_folder']->value,'htmlall','UTF-8' ));
}
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['current_folder']->value,'htmlall','UTF-8' ));?>
			...
			<div class="pull-right">
				<a class="btn-insert" onclick="window.parent.document.getElementById('media-value-' + '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['fid']->value,'htmlall','UTF-8' ));?>
').value = document.getElementById('i_url').value;window.parent.document.getElementById('media-value-' + '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['fid']->value,'htmlall','UTF-8' ));?>
').dispatchEvent(new Event('change', { bubbles: true })); window.parent.document.getElementById('media-preview-' + '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['fid']->value,'htmlall','UTF-8' ));?>
').style.backgroundImage = 'url(' + document.getElementById('i_url').value + ')'; window.parent.jQuery.fancybox.close();">Insert</a>
			</div>
		</div>
		<div class="media-list col-sm-12">
			<?php if ($_smarty_tpl->tpl_vars['current_folder']->value) {?>
			<div class="media-box">
				<div class="thumb-icon"><a href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminGdzpagebuilderMedia'),'html','UTF-8' ));?>
...
"><i class="icon-level-up"></i></a></div>
				<div class="name"><a href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminGdzpagebuilderMedia'),'html','UTF-8' ));?>
&current_folder=<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['previous_folder']->value,'htmlall','UTF-8' ));?>
			...
			<div class="media-box">
				<div class="thumb-icon">
					<?php if ($_smarty_tpl->tpl_vars['file']->value['type'] == 'jpg' || $_smarty_tpl->tpl_vars['file']->value['type'] == 'png' || $_smarty_tpl->tpl_vars['file']->value['type'] == 'jpeg' || $_smarty_tpl->tpl_vars['file']->value['type'] == 'gif') {?>
						<a class="img-thumb" onclick="document.getElementById('i_url').value = '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['file']->value['src'],'htmlall','UTF-8' ));?>
...
"><img src="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['file']->value['src'],'htmlall','UTF-8' ));?>
" /></a>
					<?php }?>
				</div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<div class="media-form upload-form">
			...
			<button name="submitImage" id="upload-file" class="btn btn-success"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Upload File','mod'=>'gdz_pagebuilder'),$_smarty_tpl ) );?>
</button> <span>(<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Maximum Size','mod'=>'gdz_pagebuilder'),$_smarty_tpl ) );?>
